...
import com.qq.networkconnecting.ClientForgotReceiveThread;
...
public class MyChangepass extends JFrame{
	public MyChangepass() {
		init();
	}
	//---north面板
...
//	//---south面板
	...
	private JLabel jbl_hint2 =new JLabel("请输入您的账号");
...
//				new MyChangepass2();
//				MyChangepass.this.dispose();
//			}
//		});
		jb_start.addActionListener(new ActionListener() {	
			@Override
			public void actionPerformed(ActionEvent e) {
				String username = jtf_acnumber.getText();
				System.out.println(jtf_acnumber.getText());
				Message message = new Message();
				User user = new User();
				user.setUsername(username);
				message.setUser(user);
				message.setChatStatus(ChatStatus.isExistUser);
				ConnectUtil.isExistConnectServer(message,MyChangepass.this);
			}
		});
